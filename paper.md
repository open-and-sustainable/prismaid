...
# State of the Field
AI approaches to support SLRs have been extensively explored, with significant contributions to methodological frameworks and approaches [@van_dinter_automation_2021; @mahadevkar_exploring_2024], as well as advancements in specific tasks like information extraction [@abdullah_systematic_2023]. Building on these foundations, several tools have been developed for scientific applications [@khalil_tools_2022; @affengruber_exploration_2024], including commercial options like @distiller_SR. While these tools demonstrate promise, they often face limitations such as discipline specificity [@liu_autoie_2024], a focus on literature selection rather than extraction [@donoghue_lisc_2019], and the need for substantial human intervention [@kiritchenko_exact_2010; @saldanha_evaluating_2016]. Recent evidence highlights the potential of LLMs to enhance SLRs broadly [@alshami_harnessing_2023] and automate information extraction specifically [@schopow_applications_2023]. Building on this evidence, `prismAId` offers an open-source, community-oriented solution that leverages advanced, state-of-the-art, commercial-grade AI tools for automating information extraction within established SLR protocols, addressing gaps in accessibility, scalability, and methodological rigor.
