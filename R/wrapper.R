...
.onLoad <- function(libname, pkgname) {
  ...
  if (os_type == "windows") {
    ...
    # Set DYLD_LIBRARY_PATH on macOS to help with locating the .dylib file
    Sys.setenv(DYLD_LIBRARY_PATH = dirname(library_path))
    message("Set DYLD_LIBRARY_PATH to: ", dirname(library_path))
